...
export const LOCALE = {
  ...
  langTag: ["en-SG"], // BCP 47 Language Tags. Set this empty [] to use the environment default
} as const;
...
export const SOCIALS: SocialObjects = [
  {
    name: "Github",
    href: "https://github.com/lesterong",
    linkTitle: `lesterong on Github`,
    active: true,
  },
  {
    name: "Facebook",
  ...
  },
  {
    ...
    linkTitle: `Lester Ong on LinkedIn`,
    active: true,
  },
  {
    name: "Mail",
